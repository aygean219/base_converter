...
{
	cout << "1.Conversii" << endl;
	cout << "2.Calcule" << endl;
	cout << "3.Oprire program" << endl;
}
void UI::meniu_conversii()
{
	...
	cout << "4.Conversii rapide." << endl;
	cout << "5.Back" << endl;
}
void UI::meniu_conversii_rapide()
{
	cout << "a)Din baza 2 in baza 4." << endl;
	cout << "b)Din baza 2 in baza 8." << endl;
	cout << "c)Din baza 2 in baza 16." << endl;
	cout << "d)Din baza 4 in baza 2." << endl;
	cout << "e)Din baza 8 in baza 2." << endl;
	cout << "f)Din baza 16 in baza 2." << endl;
	cout << "g)Back" << endl;
}
void UI::meniu_calcule()
{
	cout << "1.Adunarea a 2 a numere." << endl;
	cout << "2.Scaderea a 2 a numere." << endl;
	cout << "3.Inmultirea unui numar cu o cifra." << endl;
	cout << "4.Impartirea unui numar cu o cifra." << endl;
	cout << "5.Back" << endl;
}
...
void UI::conversii_b2_in_b16()
{
	...
	try {
		cin >> nr;
		if (nr.size() % 4 != 0)//arunca exceptie daca in loc de 001 se introduce 1
			throw "Nu ati introdus un numar corect!La fiecare 3 cifre din baza 2 ii corespunde 1 cifra in baza 8.";
		Numar n(nr, 16);
	...
	while (!gata)
	{
		...
		case 1: {
			...
			while (!gata2)
			{
				...
				case 4:
				{
					...
					while (!gata3)
					{
						meniu_conversii_rapide();
						char opt2;
						cin >> opt2;
						switch (opt2)
						{
						case 'a': {conversii_b2_in_b4(); break; }
						case 'b': {conversii_b2_in_b8(); break; }
						case 'c': {conversii_b2_in_b16(); break; }
						case 'd': {conversii_b4_in_b2(); break; }
						case 'e': {conversii_b8_in_b2(); break; }
						case 'f': {conversii_b16_in_b2(); break; }
						case 'g': {gata3 = true; }
						}
					}
		...
		case 2: {
			...
			while (!gata4)
			{
				...
				switch (opt4)
				{
				case 1: {adunare(); break; }
				case 2: {scadere(); break; }
				case 3: {inmultire(); break; }
				case 4: {impartire(); break; }
				case 5: { gata4 = true;  }
				}
			}
		}
		case 3: { gata = true; }//break; }
		}
	}
}